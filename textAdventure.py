...
myChoice = ""
enemy = ""
#store all choices we make in the game
#to output into txtLog
myChoices = []
...
def gameStart():
    ...
    #storing name in choiceArray
    myChoices.append(myChoice)
    #storing name in dictionary
...
if not (action.lower == "left"):
    startFight("bandit")
#after startFight is over, end game
#create log for game
file = open(fileDir + "txtLog.txt","w")


#Name: playerName
#Class: playerClass
#1st Action: take a left on the fork in the road
#Lost the fight with the bandit
#
#